...
class MessageCatcher(PlugIn):
    ...
    def plugin(self, server):
        self._data = {}
        self._owner = server
        server.Dispatcher.RegisterHandler('message', self.
            messageHandler, xmlns=NS_CLIENT)

    def plugout(self):
        self._owner.Dispatcher.UnregisterHandler('message', self.
            messageHandler)
