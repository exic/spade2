...
#class WebAdminHandler(CGIHTTPServer.CGIHTTPRequestHandler):
    ...
    def setPageTemplate(self):
        ...
        self._body = self._body.replace("#MENU_LEFT#",
             '<a class=lateral href="/">Main</a><br/><a class=lateral href="/pref">Preferences</a><br/><a class=lateral href="/clients">Active Clients</a><br/><a class=lateral href="/plugins">Plugins</a>')
...
#               """
#
#               self.cgi_directories.append("/xmppd/modules/web")
#               self.cgi_directories.append("/modules/web")
#               if self.is_cgi():
#                       self.run_cgi()
#               else:
#                       self.send_error(501, "Can only POST to CGI scripts")
#
#               print "READ: ", self.rfile.read()
    ...
    def do_GET(self):
        ...
        if page.endswith("css"):
            ...
            if "jabber" in vars:
                ...
                self.sendFIPAMsg(vars["to"], vars[
                    "performative"], vars["content"])
            ...
            for cl in self.server.xmppd.routes.keys():
                ...
                cp = cp + """<a href='/send?to=""" + str(cl)
                    +"""'>""" + str(cl)
                        + """</a></td><td>""" + simplexml.XMLescape(str(pres)) + """</td></tr>"""
            ...
            self._body = self._body.replace("#TIME#", time.
    ...
    def plugin(self, server):
        ...
        try:
            ...
            self.httpd = SocketServer.ThreadingTCPServer(('',
                 WEB_ADMIN_PORT), WebAdminHandler)
            ...
            self.DEBUG("WebAdmin Error: could not open port " +
                str(WEB_ADMIN_PORT), "error")
