...
server-node-registered -- en -- Registered %(fileno)
    s using %(method)s (%(raw)s) %(socker_notice)s
...
globals()['LANG_LIST'] = [en_server_localized_strings,
    fr_server_localized_strings,ja_server_localized_strings,ru_server_localized_strings]
