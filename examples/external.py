...
class external(Agent.Agent):
    class SenderBehav(Behaviour.OneShotBehaviour):
        def _process(self):
            ...
            msg.addReceiver(AID.aid("external@" + self.myAgent.
                host, ["http://" + self.myAgent.host + ":1099/JADE"]))
    ...
    class RegisterBehav(Behaviour.OneShotBehaviour):
        def _process(self):
            ...
            #print dad
            otherdf = AID.aid("df@" + self.myAgent.host +
                ":1099/JADE", ["http://" + self.myAgent.host + ":7778/acc"])
