...
class MyAgent(spade.Agent.Agent):
    ...
    def _setup(self):
        ...
        b.registerTransition(self.STATE_ONE_CODE, self.
            STATE_ONE_CODE, self.TRANSITION_DEFAULT)
        b.registerTransition(self.STATE_ONE_CODE, self.
            STATE_TWO_CODE, self.TRANSITION_TO_TWO)
        b.registerTransition(self.STATE_TWO_CODE, self.
            STATE_TWO_CODE, self.TRANSITION_DEFAULT)
        b.registerTransition(self.STATE_TWO_CODE, self.
            STATE_THREE_CODE, self.TRANSITION_TO_THREE)
        b.registerTransition(self.STATE_THREE_CODE, self.
            STATE_THREE_CODE, self.TRANSITION_DEFAULT)
        b.registerTransition(self.STATE_THREE_CODE, self.
            STATE_FOUR_CODE, self.TRANSITION_TO_FOUR)
        b.registerTransition(self.STATE_FOUR_CODE, self.
            STATE_FOUR_CODE, self.TRANSITION_DEFAULT)
