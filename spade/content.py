...
class ContentObject(dict):
    ...
    def DEACTIVATED__setattr__(self, key, value):
        ...
        """
        #print "KEY: ", key, "VALUE: ", value
        if not '_ContentObject__initialised' in self.__dict__:
    ...
    def asRDFXML(self):
        # Build rdf:RDF node
        root = simplexml.Node("rdf:RDF", {"xmlns:rdf":
...
if __name__ == "__main__":
    ...
    sco["rdf:Description"]["foaf:primaryTopic"]["spade:friend"].append(
        "John Doe")
    sco["rdf:Description"]["foaf:primaryTopic"]["spade:friend"].append(
        "Chuck Bartowski")
    sco["rdf:Description"]["foaf:primaryTopic"]["spade:friend"].append(
