...
class BasicFipaDateTime:
    ...
    def fromString(self, string):
        ...
        if string != None and string != "":
            ...
            self.calendar = datetime(year, month, day, hour,
                 minute, second, milli)
    ...
    def setYear(self, year):
        self.calendar = datetime(year, self.getMonth(), self.getDay(
            ),self.getHour(),self.getMinutes(),self.getSeconds(),self.getMilliseconds(),self.getTypeDesignator())

    def getMonth(self):
        return self.calendar.month

    def setMonth(self, month):
        self.calendar = datetime(self.calendar.year, month, self.
            calendar.day,self.calendar.hour,self.calendar.minute,self.calendar.second,self.calendar.microsecond,self.calendar.tzinfo)

    def getDay(self):
        return self.calendar.day

    def setDay(self, day):
        self.calendar = datetime(self.calendar.year, self.calendar.
            month,day,self.calendar.hour,self.calendar.minute,self.calendar.second,self.calendar.microsecond,self.calendar.tzinfo)
    ...
    def setHour(self, hour):
        self.calendar = datetime(self.calendar.year, self.calendar.
            month, self.calendar.day,hour,self.calendar.minute,self.calendar.second,self.calendar.microsecond,self.calendar.tzinfo)
    ...
    def setMinutes(self, minute):
        self.calendar = datetime(self.calendar.year, self.calendar.
            month, self.calendar.day,self.calendar.hour,minute,self.calendar.second,self.calendar.microsecond,self.calendar.tzinfo)
    ...
    def setSeconds(self, second):
        self.calendar = datetime(self.calendar.year, self.calendar.
            month, self.calendar.day,self.calendar.hour,self.calendar.minute,second,self.calendar.microsecond,self.calendar.tzinfo)
    ...
    def setMilliseconds(self, milli):
        self.calendar = datetime(self.calendar.year, self.calendar.
            month, self.calendar.day,self.calendar.hour,self.calendar.minute,self.calendat.second,microsecond,self.calendar.tzinfo)
    ...
    def __str__(self):
        ...
        """
        str_date = str(self.getYear()) + self.paddedInt(2, self.
            getMonth()) + self.paddedInt(2, self.getDay()) + "T"
        str_date = str_date + str(self.paddedInt(2, self.getHour()))
        str_date = str_date + str(self.paddedInt(2, self.getMinutes(
            ))) + str(self.paddedInt(2,self.getSeconds())) + str(self.paddedInt(3,self.getMilliseconds()))
